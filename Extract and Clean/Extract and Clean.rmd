...
First, we load our data:
  ```{r}
Campbell <- read.csv(url("https://raw.githubusercontent.com/tommymtang/Hugo-Predictions/master/Dataset/Campbell.csv"))
Nebula <- read.csv(url("https://raw.githubusercontent.com/tommymtang/Hugo-Predictions/master/Dataset/Nebula%20nominees.csv"))
Hugo <- read.csv(url("https://raw.githubusercontent.com/tommymtang/Hugo-Predictions/master/Dataset/Hugo%20nominees.csv"))
```
...
```{r, include = FALSE}
library(RCurl)
scriptURL <- "https://raw.githubusercontent.com/tommymtang/Hugo-Predictions/master/Scripts/prep-Data.R"
...
```{r, include = FALSE}
Locus <- read.csv(url("https://raw.githubusercontent.com/tommymtang/Hugo-Predictions/master/Dataset/Locus%20Finalists%20and%20Winners.csv"))
```
...
```{r, include = FALSE} 
source('~/R/Hugo-Predictions/Scripts/config.R')
```
